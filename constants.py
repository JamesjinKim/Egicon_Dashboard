"""BME688/BME680 센서 상수 정의"""

# BME688 General config
POLL_PERIOD_MS = 10
...
# BME688 unique chip identifier
CHIP_ID = 0x61

# BME688 coefficients related defines
COEFF_SIZE = 41
COEFF_ADDR1_LEN = 25
COEFF_ADDR2_LEN = 16

# BME688 field_x related defines
FIELD_LENGTH = 17
...
# BME688 register buffer index settings
REG_FILTER_INDEX = 5
REG_TEMP_INDEX = 4
REG_PRES_INDEX = 4
REG_HUM_INDEX = 2
...
class FieldData:
    """Structure for storing BME688 sensor data."""
...
class CalibrationData:
    """Structure for storing BME688 calibration data."""
...
class TPHSettings:
    """Structure for storing BME688 sensor settings.
...
class GasSettings:
    """Structure for storing BME688 gas settings and status."""
...
class BME688Data:
    """Structure to represent BME688 device."""
