...
BME688 + BH1750 실제 센서를 사용한 온도, 습도, 압력, 조도, 공기질 데이터의 실시간 모니터링 및 시각화를 제공하는 Flask 기반 웹 대시보드입니다.
...
- ✅ **Flask UI 구조 개선**: 모듈화된 템플릿 시스템으로 업그레이드
- ✅ **센서 매니저 최적화**: BME688 + BH1750 자동 검색 및 연결
- ✅ **실시간 대시보드**: Chart.js 기반 6개 센서 위젯 및 차트
- ✅ **constants.py 복원**: 센서 확장성을 위한 상수 정의 파일
- ✅ **통합 테스트 도구**: test_sensors.py로 시스템 전체 테스트 가능
